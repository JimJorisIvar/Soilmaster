...
gulp.task('angularjs:html', () => {
  /* Template */
  gulp.src(['src/angularjs/**/*.html', '!src/angularjs/elements/*.html', '!src/angularjs/components/*.html', '!src/angularjs/components/admin.php'])
    .pipe(fileinclude({
      prefix: '@@',
      basepath: '@file'
    }))
  ...
  /* Index */
  return gulp.src(['src/angularjs/admin.php'])
    .pipe(fileinclude({
      prefix: '@@',
      basepath: '@file'
    }))
